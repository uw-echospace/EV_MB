...
# Convert 'Relhum' column to numeric values, ignoring non-numeric entries
data['Relhum'] = pd.to_numeric(data['Relhum'], errors='coerce')
...
ax1.set_title('2023 UWUH Relative Humidity')
